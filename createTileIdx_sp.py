# -*- coding: utf-8 -*-
#   读取当前目录下moon_sp图层信息，生成相应图层序号，并保存至tile_idx_sp.xlsx中
...
folders = [name for name in subdirectories if name.startswith("Moon_sp")]
...
# 保存DataFrame到Excel文件
df.to_excel('tile_idx_sp.xlsx', index=False)
